...
"""
Time Complexity: O(logN), O(1) for constructor + O(1) for setter, O(logN) for getter
Space Complexity: O(M * N), M is the number of keys while N is the size of the list of each key stored
"""
